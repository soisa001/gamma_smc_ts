#!/usr/bin/env python
"""Command-line entry point for the run4 selection-detection study.

    python scripts/run_run4.py validate
    python scripts/run_run4.py simulate --slim-bin ... --workers 20
    python scripts/run_run4.py decode  --decoder-bin ... --workers 20
    python scripts/run_run4.py analyze
    python scripts/run_run4.py plot
"""
...
from gamma_smc_aou.run4_config import ARMS, MODES, N_REPLICATES  # noqa: E402
from gamma_smc_aou.run4_workflow import PHASES, run_phase  # noqa: E402
