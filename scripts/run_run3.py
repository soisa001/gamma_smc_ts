#!/usr/bin/env python
"""Command-line entry point for the run3 selection-detection study.

    python scripts/run_run3.py validate
    python scripts/run_run3.py simulate --slim-bin ... --workers 20
    python scripts/run_run3.py decode  --decoder-bin ... --workers 20
    python scripts/run_run3.py analyze
    python scripts/run_run3.py plot
"""
...
from gamma_smc_aou.run3_config import ARMS, MODES, N_REPLICATES  # noqa: E402
from gamma_smc_aou.run3_workflow import PHASES, run_phase  # noqa: E402
